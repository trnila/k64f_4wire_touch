...
#define MBED_CONF_APP_PIN_BTN_DEMO                        SW3    // set by application[K64F]
#define MBED_CONF_APP_PIN_YM                              A0     // set by application[K64F]
#define MBED_LFS_READ_SIZE                                64     // set by library:littlefs
#define MBED_CONF_APP_PIN_SERVOX                          PTC10  // set by application[K64F]
...
#define MBED_CONF_APP_PIN_BTN_CENTER                      SW2    // set by application[K64F]
#define MBED_CONF_EVENTS_PRESENT                          1      // set by library:events
#define MBED_CONF_RTOS_PRESENT                            1      // set by library:rtos
#define MBED_CONF_APP_PIN_SERVOY                          PTC11  // set by application[K64F]
...
#define MBED_CONF_APP_PIN_YP                              A2     // set by application[K64F]
...
#define MBED_CONF_APP_PIN_XM                              A1     // set by application[K64F]
#define MBED_CONF_NSAPI_PRESENT                           1      // set by library:nsapi
#define MBED_CONF_PLATFORM_STDIO_BAUD_RATE                9600   // set by library:platform
#define MBED_CONF_APP_PIN_XP                              A3     // set by application[K64F]
